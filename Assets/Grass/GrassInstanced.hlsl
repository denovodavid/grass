...
StructuredBuffer<MeshProperties> properties;
...
// See : https://gist.github.com/Cyanilux/e7afdc5c65094bfd0827467f8e4c3c54
	...
	void vertInstancingMatrices(inout float4x4 objectToWorld, out float4x4 worldToObject) {
		MeshProperties data = properties[unity_InstanceID];

	    // positions relative to the bounds passed into DrawMeshInstancedIndirect
		// objectToWorld = mul(objectToWorld, data.trs);

		// positions in world coordinates
		// Transform matrix (override current)
		objectToWorld._11_21_31_41 = float4(data.trs._11_21_31, 0.0f);
		objectToWorld._12_22_32_42 = float4(data.trs._12_22_32, 0.0f);
		objectToWorld._13_23_33_43 = float4(data.trs._13_23_33, 0.0f);
		objectToWorld._14_24_34_44 = float4(data.trs._14_24_34, 1.0f);
